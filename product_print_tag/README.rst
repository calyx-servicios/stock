...
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fstock-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/stock.git
    :alt: calyx-servicios/stock.git

|badge1| |badge2| |badge3|

This module extends the functionality of the tags for products.
...
* Find module "product_print_tag"

* Press Install

* Go to Purchase > Receipt > Print tag > and see the modifications
