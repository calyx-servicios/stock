===============================
Stock Picking: group by partner
===============================
...
* enable "debug mode"
* be sure that in the user permissions, you checked "Manage Push
...
Bugs are tracked on `GitLab Issues <https://gitlab.com/calyxservicios-group/odoo/custom-talleres/-/issues>`_.
...
This module is part of the `OCA/stock-logistics-workflow <https://gitlab.com/calyxservicios-group/odoo/custom-talleres>`_ project on GitLab.
