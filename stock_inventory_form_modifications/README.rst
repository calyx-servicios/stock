...
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fcalyx-lightgray.png?logo=github
    ...
    :alt: calyx-servicios/stock

|badge1| |badge2| |badge3|

.. !!! Description must be max 2-3 paragraphs, and is required.

This module extends the functionality of the Inventory by adding the New Quantity field and hiding the Location and UoM fields from the form view.
